...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="views/CSS/CSSviewMentions.css">
...
<img class="logo1" src="https://zupimages.net/up/19/41/m2h6.png" alt="Infinite system">
</br>
</br>
</br>
</br>
...
<span class = "bloc-texte">
    ...
    <h3> Conditions d'utilisations </h3>
        <div>
            Ce site est exploité dans le respect de la législation française. L'utilisation de ce site est régie par les présentes conditions générales. En utilisant le site, vous reconnaissez avoir pris connaissance de ces conditions et les avoir acceptées. Celles-ci pourront êtres modifiées à tout moment et sans préavis par la société Infinit Measures.
            Infinit Measures ne saurait être tenu pour responsable en aucune manière d’une mauvaise utilisation du service.
        </div>
    </br>
    </br>
    <h3> Limitation de responsabilité </h3>
        <div>
            Les informations contenues sur ce site sont aussi précises que possibles et le site est périodiquement remis à jour, mais peut toutefois contenir des inexactitudes, des omissions ou des lacunes. Si vous constatez une lacune, erreur ou ce qui parait être un dysfonctionnement, merci de bien vouloir le signaler par email (voir page <a class = "lien" href = "index.php?action=see_contact">Contacts </a>) en décrivant le problème de la manière la plus précise possible (page posant problème, action déclenchante, type d’ordinateur et de navigateur utilisé, …).
            </br>
            </br>
            ...
            Les liens hypertextes mis en place dans le cadre du présent site internet en direction d'autres ressources présentes sur le réseau Internet ne sauraient engager la responsabilité de Infinit Measures.
        </div>
    </br>
    </br>
    ...
    <h3> Propriété intellectuelle </h3>
        <div>
            ...
            Infinit Measures est identiquement propriétaire des "droits des producteurs de bases de données" visés au Livre III, Titre IV, du Code de la Propriété Intellectuelle (loi n° 98-536 du 1er juillet 1998) relative aux droits d'auteur et aux bases de données.
        </div>
    </br>
    </br>
